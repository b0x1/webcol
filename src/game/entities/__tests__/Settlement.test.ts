...
describe('Settlement', () => {
  it('should initialize with correct values', () => {
    const settlement = createSettlement('settlement-1', 'player-1', 'Jamestown', 15, 20, 3, Culture.EUROPEAN, Organization.STATE);
  ...
  it('should have empty buildings, inventory, and production queue by default', () => {
    const settlement = createSettlement('col-1', 'p-1', 'A', 0, 0, 1, Culture.EUROPEAN, Organization.STATE);
